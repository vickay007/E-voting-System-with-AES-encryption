                                ...
                                <div class="col-xl-9 col-md-6 col-12 border-t border-right">
                                    <div class="page-account-form">
                                        <div class="form-titel border-bottom p-3">
                                            <h5 class="mb-0 py-2">Please complete your profile</h5>
                                        </div>
                                        @if(count($errors) > 0)
                                            ...
                                            {!! Form::model($user, ['route' => ['user-update', $user->id], 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      {{ Form::select('roles[]', $roles, $selectedRole, ['class' => 'form-control myselect', 'data-placeholder' => 'Select Roles', 'multiple']) }}           
                                                    </div>
                                                </div>
