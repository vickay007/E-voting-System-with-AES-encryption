...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $permission->save();
        return redirect('/permission/create')->with('success', 'Permission created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $permission->description = $request->description;
        $permission->save();
        return redirect('/permission/list')->with('success', 'Permission Updated successfully');
    }
