...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/roles/create')->with('success', 'Roles Created Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/roles/list')->with('success', 'Roles Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        $role = Role::find($id);
        $role->delete();
        return redirect('/roles/list')->with('success', 'Role Deleted Successfully');
    }
}
